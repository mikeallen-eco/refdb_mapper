...
make_hybas_phylogeny_plot(hybas_data = nj_data, metric = "p_c")
ggsave("figures/circular_phylogeny_test_p_c_NJ4.png", height = 12, width = 12, dpi = 400)
make_hybas_phylogeny_plot(hybas_data = pf_data, metric = "p_c")
ggsave("figures/circular_phylogeny_test_p_c_PF4.png", height = 12, width = 12, dpi = 400)

make_hybas_phylogeny_plot(hybas_data = nj_data, metric = "p_i")
ggsave("figures/circular_phylogeny_test_p_i_NJ.png", height = 12, width = 12, dpi = 400)
make_hybas_phylogeny_plot(hybas_data = pf_data, metric = "p_i")
ggsave("figures/circular_phylogeny_test_p_i_PF.png", height = 12, width = 12, dpi = 400)

make_hybas_phylogeny_plot(hybas_data = nj_data, metric = "p_a")
ggsave("figures/circular_phylogeny_test_p_a_NJ.png", height = 12, width = 12, dpi = 400)
make_hybas_phylogeny_plot(hybas_data = pf_data, metric = "p_a")
ggsave("figures/circular_phylogeny_test_p_a_PF.png", height = 12, width = 12, dpi = 400)
